  ...
  return (
    <div className='flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20  '>
      ...
      <div >
        ...
        <p className='my-6 text-[15px] text-gray-500'>Bg.RemoverPro is an efficient and user friendly background remover tool . <br className='max-sm:hidden' /> It is a free and open source tool that can remove the background from your images just in one click.</p>
        <div>
